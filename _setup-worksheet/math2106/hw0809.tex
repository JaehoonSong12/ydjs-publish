...
\begin{enumerate}
  ...
  \end{define}
  \begin{subprove}
    Suppose, for the sake of contradiction, that \((p_n)\) converges to a limit \(p \in \setR\).
    Let \(\varepsilon = 0.1\). 
    ...
    Thus, for any \(N\), there exist \(n_1, n_2 \geq N\) 
    such that \(p_{n_1} = 8\) and \(p_{n_2} = 5\) where $n_2=n_1 + 1$. Then,
    \[
      \abs{p_{n_1} - p} = \abs{8 - p} \quad\text{and}\quad \abs{p_{n_2} - p} = \abs{5 - p}.
    \]
    By the triangle inequality,
    \[
      \abs{8 - 5} = 3 \leq \abs{8 - p} + \abs{5 - p} < 2 \cdot \varepsilon = 0.2.
    \]
...
\begin{enumerate}
  \item Prove the following for \(n \in \setN\) from the definitions.
    \begin{enumerate}
      ...
      \begin{subprove}
        Let \(\varepsilon>0\) and $N=\left\lceil\dfrac{1}{\varepsilon} + 1\right\rceil$.
        Then, for all \(n\ge N\), \(N>\dfrac{1}{\varepsilon}\) and
        \[
          \left|\dfrac{(-1)^n}{n}-0\right|=\dfrac{1}{n}<\varepsilon.
        \]
      ...
      \begin{subprove}
        Let \(\varepsilon>0\). Let $N=\left\lceil\sqrt{\dfrac{1}{\varepsilon}} + 1\right\rceil$. 
        Then for \(n\ge N\), $N^2>\dfrac{1}{\varepsilon}$ and
        \[
          \left|\dfrac{1}{n^2}-0\right|=\dfrac{1}{n^2}<\varepsilon,
        \]
        Thus, by \nameref{def:convergence-of-a-sequence}, the sequence converges to \(0\).
      \end{subprove}
  ...
  \begin{subprove}
    ...
    Then, for all \(n\ge N\ge 3\),
    \[
      \left|\dfrac{4n^3+3n}{n^3-6}-4\right|=\left|\dfrac{3n+24}{n^3-6}\right|\le\dfrac{27n}{n^3/2}=\dfrac{54}{n^2}<\varepsilon
    \]
    since \(n^2>\dfrac{54}{\varepsilon}\).
...
\begin{enumerate}
  \item \textbf{Definition.} A sequence \((s_n)\) is a \emph{Cauchy sequence} if for every \(\varepsilon>0\) there exists \(N\in\mathbb{N}\) such that for all \(m,n>N\) we have \(\lvert s_n-s_m\rvert<\varepsilon\).
