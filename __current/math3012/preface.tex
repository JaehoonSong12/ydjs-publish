...
\begin{center}
  \begin{minipage}{\textwidth}
    ...
    endorsed or authorized by \HandoutInstitution.}\\[0.5cm]
    ...
    author. This work is subject to removal or modification if \HandoutInstitution \space
    determines it violates their Honor Code or intellectual property policies.}\\[0.5cm]

    {\small\textbf{Content and Attribution:}}\\[0.2cm]
    {\footnotesize
    This work combines concepts and approaches learned through \HandoutInstitution \space
    ...
    attribution to both \HandoutInstitution \space
  ...
  \end{minipage}
  \includegraphics[width=0.30\textwidth]{\HandoutEmblem}\\
  {\small © \PublicationYear\ \HandoutAuthor. All rights reserved.}\\[0.5cm]
  {\small Prepared by \HandoutAuthor, TA@GT}\\[1cm]
\end{center}
