...
\begin{center}
  \begin{minipage}{1.0\textwidth}
    ...
    outside of our educational programs.}\\[1cm]
    
    {\textbf{For Our Community:}}\\[0.2cm]
    {\footnotesize
    ...
    activities is not permitted.}\\[1cm]
    
    {\textbf{Content and Attribution:}}\\[0.2cm]
    {\footnotesize
    ...
    improvement, please bring them to our attention.}\\[1cm]
  \end{minipage}
  % {\textbf{Key Permissions under CC BY-NC-SA 4.0:}}\\[0.2cm]
  % {\footnotesize
  % Some content may be derived from sources under the CC0 1.0 Universal 
  % license, which allows for free use, modification, and distribution.
  % \begin{itemize}
  ...
  { © \the\year\ Hans edu LLC. All rights reserved.}\\[1cm]
\end{center}
