...
% ------------------------------------------------------------------------------
% \begin{define}{<title>}[<color>][<label>] … \end{define}
% ------------------------------------------------------------------------------
% DESCRIPTION:
...
%     A function f is continuous at a point a if for every ε > 0, 
%     there exists a δ > 0 such that |f(x) - f(a)| < ε whenever |x - a| < δ.
%   \end{define}
%
%   % Case 2: With custom color but no cross-reference
%   \begin{define}{Pythagorean Theorem}[green]
%     In a right triangle, the square of the hypotenuse equals the sum 
%     of squares of the other two sides: a² + b² = c².
%   \end{define}
%
%   % Case 3: With cross-reference label (explicitly specify graycolor)
%   \begin{define}{Fundamental Theorem of Calculus}[graycolor][thm:fundamental]
%     If f is continuous on [a,b] and F is an antiderivative of f, then
%     ∫[a to b] f(x) dx = F(b) - F(a).
%   \end{define}
%
%   % Case 4: With both custom color and cross-reference label
%   \begin{define}{Euler's Identity}[blue][eq:euler]
%     e^(iπ) + 1 = 0, where e is Euler's number, i is the imaginary unit, 
%     and π is the ratio of a circle's circumference to its diameter.
%   \end{define}
%
...
\NewDocumentEnvironment{define}{ m O{graycolor} O{} }
  {
  \vspace{2pt}
