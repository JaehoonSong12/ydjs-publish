...
\@ifpackageloaded{fancyhdr}{}{%
  \@ifundefined{lhead}{%
    ...
    \PackageInfo{core}{Skipping fancyhdr; \string\lhead already defined by class/package}%
  }%
...
\@ifpackageloaded{xcolor}{}{\usepackage{xcolor}}         % colors for text, tables, tikz
...
\@ifpackageloaded{colortbl}{}{\usepackage{colortbl}}     % row/column colors in tables
...
%   {}
% ------------------------------------------------------------------------------
\NewDocumentCommand{\handout}{O{false} m m m m m g}{%
  ...
  \IfNoValueTF{#7}{%
    ...
    \ifthenelse{\equal{#7}{}}{%
      % Empty handout number provided - keep default page numbering
    }{%
