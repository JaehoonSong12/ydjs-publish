...
10 & Diamond & Can scratch everything \\
\end{tabular}
...
\midrule
Quartz & Glassy luster, hardness 7, white streak & Glass, electronics \\
Calcite & Reacts with acid, hardness 3 & Construction, antacids \\
Gold & Metallic luster, soft, golden streak & Jewelry, electronics \\
Pyrite & Metallic luster, hard, black streak & Fool's gold, sulfur source \\
...
\begin{enumerate}
    \item \textbf{Igenous → Sedimentary:} Weathering and erosion break down igneous rocks into sediments
    \item \textbf{Sedimentary → Metamorphic:} Heat and pressure change sedimentary rocks
    \item \textbf{Metamorphic → Igenous:} Melting creates magma that cools to form igneous rocks
    \item \textbf{Any rock type can become any other rock type} through the cycle
\end{enumerate}
