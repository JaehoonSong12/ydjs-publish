...
\begin{quote}
서로 다른 두 수의 크기를 비교하는 것을 비라고 한다. 비를 나타낼 때는 기호 \inlinequote{:}를 써서 $\bullet : \blacktriangle$ 로 나타낸다. 
$\bullet : \blacktriangle$ 는 \inlinequote{$\bullet$ 대 $\blacktriangle$} 라고 읽는다.
\end{quote}
\begin{quote}
Ratios are written with the symbol \inlinequote{:}, such as $\bullet : \blacktriangle$. Comparing 
the sizes of two different numbers is called a ratio. $\bullet : \blacktriangle$ is 
read as \inlinequote{$\bullet$ to $\blacktriangle$.}
\end{quote}
...
\[
\text{28을 3 : 4로 비례배분한다. } \; 28 \times \dfrac{3}{3+4} = 28 \times \dfrac{3}{7} = 12, 
\quad 28 \times \dfrac{4}{3+4} = 28 \times \dfrac{4}{7} = 16
\]
\[
\text{81을 4 : 5로 비례배분한다. } \; 81 \times \dfrac{4}{4+5} = 81 \times \dfrac{4}{9} = 36, 
\quad 81 \times \dfrac{5}{4+5} = 81 \times \dfrac{5}{9} = 45
\]
\[
\text{Divide 28 in the ratio 3:4. } \; 28 \times \dfrac{3}{3+4} = 28 \times \dfrac{3}{7} = 12, 
\quad 28 \times \dfrac{4}{3+4} = 28 \times \dfrac{4}{7} = 16
\]
\[
\text{Divide 81 in the ratio 4:5. } \; 81 \times \dfrac{4}{4+5} = 81 \times \dfrac{4}{9} = 36, 
\quad 81 \times \dfrac{5}{4+5} = 81 \times \dfrac{5}{9} = 45
\]
