...
\newpage
\subsection{Q\&A 2 (English)}
\subsubsection{Long Question: Expanded Form}
Write the number 5,041 in expanded form. Then explain what each digit means based on its place.\\

\fullpageimage{images/qna_2_eng.png}

\newpage
\subsection{Q\&A 2 (Korean)}
\subsubsection{Long Question: Expanded Form}
Write the number 5,041 in expanded form. Then explain what each digit means based on its place.\\

\newpage
\subsection{Q\&A 2 (Typed Answer)}
\subsubsection{Long Question: Expanded Form}
Write the number 5,041 in expanded form. Then explain what each digit means based on its place.\\
...
\newpage
\subsection{Q\&A 3 (English)}
\subsubsection{Challenge Question: Comparing Numbers}
Two numbers have the same digits but in a different order: 5,104 and 4,105. Which number is greater, and how do you know? Explain using place value.\\
