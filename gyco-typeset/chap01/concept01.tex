...
% \newpage
% \subsection{Q\&A 1 (English)}
% \subsubsection{Short Question: Value of a Digit}
% What is the value of the digit 8 in the number 9836?\\


% \newpage
% \subsection{Q\&A 1 (Korean)}
% \subsubsection{Short Question: Value of a Digit}
% What is the value of the digit 8 in the number 9836?\\


% \newpage
% \subsection{Q\&A 1 (Typed Answer)}
% \subsubsection{Short Question: Value of a Digit}
% What is the value of the digit 8 in the number 9836?\\

% % \textbf{Answer:} The digit 8 is in the \textbf{hundreds place}, so its value is \textbf{800}.
...
\fullpageimage{images/qna_2_eng.png}
...
\newpage
\subsection{Question: Expanded Form (Typed Answer)}
Write the number 5,041 in expanded form. Then explain what each digit means based on its place.\\
