...
Place value turns a few digits into large or small numbers. Take $9836$. 
...
This is where you will see hand-drawing answer of the same question before in \textbf{English}.
\begin{figure}[htbp]
  \centering
...
This is where you will see hand-drawing answer of the same question before in \textbf{Korean}.
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{example-image} % put your image file in project
  \caption{A scenic travel destination (example image).}
