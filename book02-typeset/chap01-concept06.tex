...
When working with two or more numbers, it's often useful to find numbers they have in common. The \textbf{Greatest Common Factor (GCF)} is the largest number that divides two numbers exactly, while the \textbf{Least Common Multiple (LCM)} is the smallest number that both numbers divide into evenly.
