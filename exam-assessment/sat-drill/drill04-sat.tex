...
\question[1]
\insertimage{0.36}{images/2025_06_15_5ccb8dd1752fe76599e7g-010}{reference attached}
...
\]
\begin{solutionorbox}
The expression equals $(70 n)^{1/5}(70 n)^{1/3}=(70 n)^{8/15}$, so $30 x=\frac{8}{15}$ and $x=\frac{4}{225}$.
\end{solutionorbox}
