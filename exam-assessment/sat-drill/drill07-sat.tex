...
\question[1]
Data set $A$ and data set $B$ each consist of 27 values. The following table shows the frequencies of the values for each data set. Which of the following statements best compares the means of the two data sets?
\begin{center}
  \renewcommand{\arraystretch}{1.3}
  \setlength{\tabcolsep}{0.5em}
  \captionof{table}{Freq.: A \& B}\label{tab:sat-drill-07-freq-datasets-ab}%
  \vspace{0.35em}
  \begin{adjustbox}{max width=\linewidth,clip=false,margin=0pt}
  \begin{tabular}{|c|c|c|} 
    \hline
    \cellcolor[HTML]{E0E0E0}\textbf{Value} &
    \cellcolor[HTML]{E0E0E0}\makecell{\textbf{Data set A}\\\textbf{frequency}} &
    \cellcolor[HTML]{E0E0E0}\makecell{\textbf{Data set B}\\\textbf{frequency}} \\
    \hline
    30 & 2 & 9 \\
    \hline
    34 & 4 & 7 \\
...
\question[1]
The following table shows the number of international tourist arrivals, rounded to the nearest tenth of a million, to the top nine tourist destinations in both 2012 and 2013. Based on the information given in the table, how much greater, in millions, was the median number of international tourist arrivals to the top nine tourist destinations in 2013 than the median number in 2012, to the nearest tenth of a million?
\begin{center}
  \renewcommand{\arraystretch}{1.3}
  \setlength{\tabcolsep}{0.5em}
  \captionof{table}{Tourist arrivals (millions)}\label{tab:sat-drill-07-tourist-arrivals}%
  \vspace{0.35em}
  \begin{adjustbox}{max width=\linewidth,clip=false,margin=0pt}
  \begin{tabular}{|l|c|c|}
    \hline
    \cellcolor[HTML]{E0E0E0}\textbf{Country} &
    \cellcolor[HTML]{E0E0E0}\textbf{2012} &
    \cellcolor[HTML]{E0E0E0}\textbf{2013} \\
    \hline
    France & 83.0 & 84.7 \\
    \hline
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.40\linewidth]{images/2025_06_15_04f7426dc644de311e92g-15(1)} &
\includegraphics[width=0.40\linewidth]{images/2025_06_15_04f7426dc644de311e92g-15} \\
...
\begin{center}
  \includegraphics[width=0.90\linewidth]{images/2025_06_15_04f7426dc644de311e92g-16}
\end{center}
\begin{choices}
  \choice 0
  \choice 1
...
\question[1]
The frequency distribution in the following table summarizes a set of data, where $a$ is a positive integer. How much greater is the mean of the set of data than the median?
\begin{center}
  \renewcommand{\arraystretch}{1.3}
  \setlength{\tabcolsep}{0.5em}
  \captionof{table}{Value and frequency}\label{tab:sat-drill-07-value-freq-prob}%
  \vspace{0.35em}
  \begin{adjustbox}{max width=\linewidth,clip=false,margin=0pt}
  \begin{tabular}{|c|c|}
    \hline
    \cellcolor[HTML]{E0E0E0}\textbf{Value} &
    \cellcolor[HTML]{E0E0E0}\makecell{\textbf{Frequency}\\\textbf{(probability)}} \\
    \hline
    1 & $a$ \\
    \hline
    2 & $2a$ \\
...
\begin{center}
  \includegraphics[width=0.90\linewidth]{images/2025_06_15_c6d1fe032100fbb48447g-11}
\end{center}
\begin{choices}
  \choice $y=-1.9x-10.1$
  \choice $y=-1.9x+10.1$
...
\begin{center}
  \includegraphics[width=0.90\linewidth]{images/2025_06_15_c6d1fe032100fbb48447g-12}
\end{center}
...
\begin{center}
  \includegraphics[width=0.90\linewidth]{images/2025_06_15_c6d1fe032100fbb48447g-13}
\end{center}
...
\begin{center}
  \includegraphics[width=0.90\linewidth]{images/2025_06_15_c6d1fe032100fbb48447g-14}
\end{center}
\begin{choices}
  \choice $y=3x+0.8$
  \choice $y=0.8x+3$
...
\begin{center}
  \includegraphics[width=0.90\linewidth]{images/2025_06_15_c6d1fe032100fbb48447g-15}
\end{center}
...
\begin{center}
  \includegraphics[width=0.90\linewidth]{images/2025_06_15_c6d1fe032100fbb48447g-16}
\end{center}
\begin{choices}
  \choice 440
  \choice 460
...
\begin{center}
  \includegraphics[width=0.90\linewidth]{images/2025_06_15_c6d1fe032100fbb48447g-17}
\end{center}
...
\begin{center}
  \includegraphics[width=0.90\linewidth]{images/2025_06_15_c6d1fe032100fbb48447g-19}
\end{center}
\begin{choices}
  \choice 75
  \choice 125
...
\begin{center}
  \includegraphics[width=0.90\linewidth]{images/2025_06_15_c6d1fe032100fbb48447g-20}
\end{center}
\begin{choices}
  \choice $y=-x+6$
  \choice $y=-x-6$
...
\question[1]
In the table below, the ratio of $y$ to $x$ for each ordered pair is constant. What is the value of $k$?
\begin{center}
  \renewcommand{\arraystretch}{1.3}
  \setlength{\tabcolsep}{0.5em}
  \captionof{table}{$x$ and $y$}\label{tab:sat-drill-07-xy-values}%
  \vspace{0.35em}
  \begin{adjustbox}{max width=\linewidth,clip=false,margin=0pt}
  \begin{tabular}{|c|c|}
    \hline
    \cellcolor[HTML]{E0E0E0}{$x$} & \cellcolor[HTML]{E0E0E0}{$y$} \\
    \hline
    1 & 4 \\
    \hline
    3 & 12 \\
...
\begin{center}
  ...
  \begin{tabular}{|l|c|} 
    ...
    Pin oak & 3.0 \\
    \hline
    \makecell[l]{Shagbark\\hickory} & 7.5 \\
    \hline
  \end{tabular}
  \end{adjustbox}
\end{center}
...
\question[1]
The data on the coat color and eye color for 48 Himalayan kittens available for adoption were collected and summarized in the table below. What fraction of the chocolate-colored kittens has deep blue eyes?
\begin{center}
  \renewcommand{\arraystretch}{1.3}
  \setlength{\tabcolsep}{0.5em}
  \captionof{table}{Kittens: coat and eyes}\label{tab:sat-drill-07-himalayan-kittens}%
  \vspace{0.35em}
  \begin{adjustbox}{max width=\linewidth,clip=false,margin=0pt}
  \begin{tabular}{|c|c|c|c|}
    \hline
    \cellcolor[HTML]{E0E0E0}\textbf{Coat color} &
    \multicolumn{3}{|c|}{\cellcolor[HTML]{E0E0E0}\textbf{Eye color}} \\
    \hline
    \cellcolor[HTML]{E0E0E0}\mbox{} &
    \cellcolor[HTML]{E0E0E0}\textbf{Deep blue} &
    \cellcolor[HTML]{E0E0E0}\textbf{Light brown} &
    \cellcolor[HTML]{E0E0E0}\textbf{Total} \\
    \hline
    \makecell{Cream-\\{}tortoiseshell} & 16 & 16 & 32 \\
    \hline
    Chocolate & 12 & 4 & 16 \\
    \hline
    Total & 28 & 20 & 48 \\
...
\question[1]
The following table shows the number of students from two different high schools who completed summer internships in each of five years. No student attended both schools. Of the students who completed a summer internship in 2010, which of the following represents the fraction of students who were from Valley High School?
\begin{center}
  \renewcommand{\arraystretch}{1.3}
  \setlength{\tabcolsep}{0.5em}
  \captionof{table}{Internships by year}\label{tab:sat-drill-07-summer-internships}%
  \vspace{0.35em}
  \begin{adjustbox}{max width=\linewidth,clip=false,margin=0pt}
  \begin{tabular}{|l|c|c|c|c|c|}
    \hline
    \cellcolor[HTML]{E0E0E0}\makecell[l]{\textbf{High school}} &
    \multicolumn{5}{|c|}{\cellcolor[HTML]{E0E0E0}\textbf{Year}} \\
    \hline
    \cellcolor[HTML]{E0E0E0}\mbox{} &
    \cellcolor[HTML]{E0E0E0}\textbf{2008} &
    \cellcolor[HTML]{E0E0E0}\textbf{2009} &
    \cellcolor[HTML]{E0E0E0}\textbf{2010} &
    \cellcolor[HTML]{E0E0E0}\textbf{2011} &
    \cellcolor[HTML]{E0E0E0}\textbf{2012} \\
    \hline
...
\question[1]
A total of 25 men registered for singing lessons. The frequency table below shows how many of these singers have certain voice types. If one of these singers is selected at random, what is the probability he is a baritone?
\begin{center}
  \renewcommand{\arraystretch}{1.3}
  \setlength{\tabcolsep}{0.5em}
  \captionof{table}{Voice types}\label{tab:sat-drill-07-voice-types}%
  \vspace{0.35em}
  \begin{adjustbox}{max width=\linewidth,clip=false,margin=0pt}
  \begin{tabular}{|c|c|}
    \hline
    \cellcolor[HTML]{E0E0E0}\textbf{Voice type} &
    \cellcolor[HTML]{E0E0E0}\makecell{\textbf{Number of}\\\textbf{singers}} \\
    \hline
    Countertenor & 4 \\
    \hline
    Tenor & 6 \\
...
\question[1]
A survey taken by 1,000 students at a school asked whether they played school sports. The following table summarizes all 1,000 responses from the students surveyed. How many of the males surveyed responded that they do not play a school sport?
\begin{center}
  \renewcommand{\arraystretch}{1.3}
  \setlength{\tabcolsep}{0.5em}
  \captionof{table}{Sports survey}\label{tab:sat-drill-07-school-sports-survey}%
  \vspace{0.35em}
  \begin{adjustbox}{max width=\linewidth,clip=false,margin=0pt}
  \begin{tabular}{|l|c|c|}
    \hline
    \cellcolor[HTML]{E0E0E0}\mbox{} &
    \cellcolor[HTML]{E0E0E0}\textbf{Males} &
    \cellcolor[HTML]{E0E0E0}\textbf{Females} \\
    \hline
    \makecell[l]{\textbf{Play a}\\\textbf{school sport}} & 312 & 220 \\
    \hline
    \makecell[l]{\textbf{Do not play a}\\\textbf{school sport}} & $?$ & 216 \\
    \hline
  \end{tabular}
  \end{adjustbox}
\end{center}
...
\question[1]
Human blood can be classified into four common blood types-A, B, AB, and O. It is also characterized by the presence $(+)$ or absence $(-)$ of the rhesus factor. The following table shows the distribution of blood type and rhesus factor for a group of people. If one of these people who is rhesus negative $(-)$ is chosen at random, the probability that the person has blood type $B$ is $\frac{1}{9}$. What is the value of $x$?
\begin{center}
  \renewcommand{\arraystretch}{1.3}
  \setlength{\tabcolsep}{0.5em}
  \captionof{table}{Blood type and Rh}\label{tab:sat-drill-07-blood-rhesus}%
  \vspace{0.35em}
  \begin{adjustbox}{max width=\linewidth,clip=false,margin=0pt}
  \begin{tabular}{|c|c|c|c|c|}
    \hline
    \cellcolor[HTML]{E0E0E0}\mbox{} &
    \multicolumn{4}{|c|}{\cellcolor[HTML]{E0E0E0}\textbf{Blood type}} \\
    \hline
    \cellcolor[HTML]{E0E0E0}\makecell{\textbf{Rhesus}\\\textbf{factor}} &
    \cellcolor[HTML]{E0E0E0}\textbf{A} &
    \cellcolor[HTML]{E0E0E0}\textbf{B} &
    \cellcolor[HTML]{E0E0E0}\textbf{AB} &
    \cellcolor[HTML]{E0E0E0}\textbf{O} \\
    \hline
    + & 33 & 9 & 3 & 37 \\
    \hline
    - & 7 & 2 & 1 & $x$ \\
