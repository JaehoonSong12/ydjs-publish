...
\begin{choices}
  \CorrectChoice $\begin{aligned} s+p&=250 \\ 5s+12p&=2,300 \end{aligned}$
  \choice $\begin{aligned} s+p&=250 \\ 12s+5p&=2,300 \end{aligned}$
  \choice $\begin{aligned} 5s+12p&=250 \\ s+p&=2,300 \end{aligned}$
  \choice $\begin{aligned} 12s+5p&=250 \\ s+p&=2,300 \end{aligned}$
\end{choices}
