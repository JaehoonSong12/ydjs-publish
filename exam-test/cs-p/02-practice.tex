...
% Place image files under \texttt{exam-test/images/} using the basenames below (e.g.\ \texttt{.png} or \texttt{.pdf}).
...
\begin{center}
  \includegraphics[width=0.30\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-04_802_418_380_850}
\end{center}
...
\begin{center}
  \includegraphics[width=0.35\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-05_322_321_433_902}
\end{center}

Consider the following code segment, which moves the robot in the grid.
\begin{center}
  \includegraphics[width=0.35\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-05_558_652_863_734}
\end{center}
...
\begin{center}
  \begin{minipage}[t]{0.24\linewidth}\centering
    \textbf{(A)}\\[0.5em]
    \includegraphics[width=\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-05_321_322_1512_433}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.24\linewidth}\centering
    \textbf{(B)}\\[0.5em]
    \includegraphics[width=\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-05_321_323_1512_1194}
  \end{minipage}
  \begin{minipage}[t]{0.24\linewidth}\centering
    \textbf{(C)}\\[0.5em]
    \includegraphics[width=\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-05_325_326_1916_433}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.24\linewidth}\centering
    \textbf{(D)}\\[0.5em]
    \includegraphics[width=\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-05_325_325_1916_1194}
  \end{minipage}
\end{center}
\begin{choices}
  \CorrectChoice (A)
...
\begin{center}
  \begin{minipage}[t]{0.24\linewidth}\centering
    \textbf{(A)}\\[0.4em]
    \includegraphics[width=\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-08_321_201_416_433}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.24\linewidth}\centering
    \textbf{(B)}\\[0.4em]
    \includegraphics[width=\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-08_321_201_416_1194}
  \end{minipage}
  \begin{minipage}[t]{0.24\linewidth}\centering
    \textbf{(C)}\\[0.4em]
    \includegraphics[width=\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-08_321_201_820_433}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.24\linewidth}\centering
    \textbf{(D)}\\[0.4em]
    \includegraphics[width=\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-08_321_201_820_1194}
  \end{minipage}
\end{center}
\begin{choices}
  \choice (A)
...
\begin{center}
  \includegraphics[width=0.35\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-09_824_1121_1194_502}
\end{center}
\begin{choices}
...
\begin{center}
  \includegraphics[width=0.35\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-12_463_461_476_833}
\end{center}

Consider the procedure \texttt{MoveAndTurn} below.
\begin{center}
  \includegraphics[width=0.35\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-12_422_544_1162_700}
\end{center}
...
\begin{center}
  \begin{minipage}[t]{0.24\linewidth}\centering
    \textbf{(A)}\\[0.4em]
    \includegraphics[width=\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-12_222_409_1697_423}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.24\linewidth}\centering
    \textbf{(B)}\\[0.4em]
    \includegraphics[width=\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-12_218_398_1701_1190}
  \end{minipage}
  \begin{minipage}[t]{0.24\linewidth}\centering
    \textbf{(C)}\\[0.4em]
    \includegraphics[width=\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-12_218_403_2015_429}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.24\linewidth}\centering
    \textbf{(D)}\\[0.4em]
    \includegraphics[width=\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-12_218_394_2015_1194}
  \end{minipage}
\end{center}
\begin{choices}
...
\begin{center}
  \includegraphics[width=0.35\linewidth]{images/68b75e92-b243-4d72-a2a7-db8b0e1b4bf4-15_602_656_382_732}
\end{center}
