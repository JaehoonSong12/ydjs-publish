...
\runningheader{Computer Science Principles}{AP Practice Exam (Set 1)}{Page \thepage\ of \numpages}

\begingradingrange{csp}

% Pseudocode: \texttt{lstlisting} with \texttt{[style=pseudo]} (\texttt{preamble-code.tex}).
...
\begin{checkboxes}
  \choice \texttt{IF hot DISPLAY (hot AND humid)}
