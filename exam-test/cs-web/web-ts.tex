...
% Questions merged into \texttt{cs-web-adv/web-typescript.tex} were removed from this file.
% See \texttt{cs-web-adv/web-typescript-merged-from-web-ts.txt} for the exclusion list.
...
\begin{choices}
  ...
  \choice SQL Server
  \choice Angular's \lstinline[style=htmlinline]|<router-outlet>|
\end{choices}
\begin{solution}
...
\end{choices}
\begin{solution}
  Property decorators run against the prototype property (or field). \lstinline[style=tsinline]|@Input() title: string| tells Angular the parent may bind \lstinline[style=htmlinline]|[title]|; \lstinline[style=tsinline]|@Output() saved| pairs with an \lstinline[style=tsinline]|EventEmitter|.
\end{solution}
