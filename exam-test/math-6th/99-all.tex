...
\begin{center}
  \includegraphics[width=0.88\linewidth]{images/25b2bbb6-511f-4540-805d-d84ad3778da8-1_214_766_1353_1250}
\end{center}
\begin{center}
  \textbf{Meal Prices (\$)}
\end{center}
...
\begin{center}
  \includegraphics[width=0.88\linewidth]{images/25b2bbb6-511f-4540-805d-d84ad3778da8-2_592_532_459_1400}
\end{center}
\makeemptybox{1.5in}
\begin{solution}
...
\begin{center}
  \includegraphics[width=0.88\linewidth]{images/25b2bbb6-511f-4540-805d-d84ad3778da8-2_293_626_1095_1226}
\end{center}
\makeemptybox{1.5in}
\begin{solution}
...
\begin{parts}
  ...
  \begin{center}
    \includegraphics[width=0.88\linewidth]{images/25b2bbb6-511f-4540-805d-d84ad3778da8-2_334_581_1443_1426}
  \end{center}
  \makeemptybox{0.9in}
\end{parts}
\begin{solution}
  Volume $=$ (length)(width)(height) in cubic inches. For $\frac{1}{2}$ inch cubes, divide each edge length by $\frac{1}{2}$ (double each dimension) and multiply the counts, or divide total volume by $\left(\frac{1}{2}\right)^3$.
\end{solution}
...
\begin{choices}
  ...
  \begin{minipage}[t]{0.82\linewidth}
    \includegraphics[width=\linewidth]{images/25b2bbb6-511f-4540-805d-d84ad3778da8-4_85_459_1009_459}
  \end{minipage}
  \choice
  \begin{minipage}[t]{0.82\linewidth}
    \includegraphics[width=\linewidth]{images/25b2bbb6-511f-4540-805d-d84ad3778da8-4_85_461_1009_951}
  \end{minipage}
  \CorrectChoice
  \begin{minipage}[t]{0.82\linewidth}
    \includegraphics[width=\linewidth]{images/25b2bbb6-511f-4540-805d-d84ad3778da8-4_92_458_1140_468}
  \end{minipage}
  \choice
  \begin{minipage}[t]{0.82\linewidth}
    \includegraphics[width=\linewidth]{images/25b2bbb6-511f-4540-805d-d84ad3778da8-4_94_497_1138_941}
  \end{minipage}
\end{choices}
\begin{solution}
...
\begin{center}
  \includegraphics[width=0.88\linewidth]{images/25b2bbb6-511f-4540-805d-d84ad3778da8-4_602_590_2015_758}
\end{center}
\makeemptybox{1.2in}
\begin{solution}
