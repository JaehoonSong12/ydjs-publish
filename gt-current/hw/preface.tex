...
\begin{center}
  \begin{minipage}{0.85\textwidth}
    ...
    author. This work is subject to removal or modification if \HandoutInstitution 
    determines it violates their Honor Code or intellectual property policies.}\\[0.5cm]

    {\small\textbf{Content and Attribution:}}\\[0.2cm]
    {\footnotesize
    This work combines concepts and approaches learned through \HandoutInstitution 
  ...
  {\small © \the\year\ \HandoutAuthor. All rights reserved.}\\[0.5cm]
