...
% Slide 5: Abstraction example --- Minecraft (visible outcome)
\begin{frame}{Abstraction: Example of Minecraft Modding}
  \begin{center}
    \includegraphics[width=0.98\linewidth,height=0.72\textheight,keepaspectratio]{images/abstraction_of_minecraft_modding_ingame.png}
  \end{center}
  \vspace{-0.12cm}
  \begin{footnotesize}
    New blocks and items show up in the world long before you worry about rendering meshes or chunk storage---that is the \textbf{player-facing} side of abstraction.
  \end{footnotesize}
\end{frame}

% Slide 6: Abstraction example --- mod code (libraries hide engine detail)
\begin{frame}{Abstraction: Adding Content with Java \& Game Libraries}
  \begin{center}
    \includegraphics[width=0.98\linewidth,height=0.72\textheight,keepaspectratio]{images/abstraction_of_minecraft_modding.png}
  \end{center}
  \vspace{-0.12cm}
  \begin{footnotesize}
    Modding APIs (\texttt{Registry}, block/item types, identifiers) \textbf{abstract} the heavy lifting: the libraries are the abstraction layer for ``adding'' things.
  \end{footnotesize}
\end{frame}
...
% Slide 7: Java Compilation & Execution Workflow (Compilation Diagram)
...
% Slide 9: The Computational Problem
...
% Slide 10: The Mathematical Theory
...
% Slide 11: Taylor Series of $\sin(x)$
...
% Slide 12: Implementation in Java
...
% Slide 13: Implementation in Python
...
% Slide 15: Real-world uses of transcendentals and linear algebra
